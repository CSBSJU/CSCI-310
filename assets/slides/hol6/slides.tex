...
\begin{document}
  ...
  \begin{frame}[fragile]{FIXME --- listings testing}
  %{{{1
    \vspace{3\baselineskip}

    \begin{scriptsize}
      \begin{codeblock}[escapechar=!,linewidth=.6\linewidth]
       int!
      ...
      \begin{tikzpicture}[remember picture, overlay,
          ...
          every node/.append style = { align = center, minimum height = 10pt,
                        ...
                        text width=1.5cm ]
        \node [above left=1em and -2.5em of a] (A) {return value type};
        \node [above left=4em and -0.5em of b] (B) {function name};
        \node [above=2em of c] (C) {list of formal parameters};
