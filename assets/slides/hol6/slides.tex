  ...
  \newcommand{\pointers}[1]{%
    \foreach \s/\e in {##1}
    {
      \draw[ptr]
        ...
        ([xshift=\displs]var\s.\polar) --
        ([xshift=\displs]var\e.\polar) --
        (var\e.\polar);
    }%
  }%
  \newcommand{\nulls}[1]{%
    \foreach \s in {##1}
    {
      \draw[fill]
        (var\s.center) node[dot] {} --
        ([xshift=\displs]var\s.\polar) node[null] {};
    }%
  }%
  \newcommand{\frames}[1]{%
    \foreach [
...
\begin{document}
  ...
  %{{{1
    \begin{figure}
      ...
      \begin{subfigure}[b]{.30\textwidth}
        \centering
        \begin{tikzstack}[bg]{west}
          % global variables
          \variables{j/424,ch/N,ptr1/,ptr2/}
          % valid pointers
          \pointers{3/1,3/2}
          % null pointers
          \nulls{4}
